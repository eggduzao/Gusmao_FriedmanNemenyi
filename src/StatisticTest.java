...
public class StatisticTest {
	...
	public static void main(String []args) throws IOException{
		...
		String []arquivos = {
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_COD1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_COD2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_CTRL.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_MIX1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_MIX2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_NCOD.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/cont/SVM_RAND.txt",

				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_COD1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_COD2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_CTRL.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_MIX1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_MIX2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_NCOD.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/test/disc/SVM_RAND.txt",
				
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_COD1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_COD2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_CTRL.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_MIX1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_MIX2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_NCOD.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/cont/SVM_RAND.txt",
				
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_COD1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_COD2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_CTRL.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_MIX1.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_MIX2.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_NCOD.txt",
				"C:/Eduardo/Projects/Eclipse Works/FriedmanNemenyi/FriedmanNemenyi/train/disc/SVM_RAND.txt"
			//*************************************************************************************
			//Descomentar aqui e colocar o caminho para cada um dos arquivos de resultado, e.g.,
			/*"/media/dados/DropBox/resultado.txt",
			"/home/pablo/Desktop/entrada_teste.txt",
			mais arquivos, se necessario...  */
			//*************************************************************************************
		};
		...
		for(String arq : arquivos ){
			...
			try {
				...
				outFile.write("Estatísticas -- "+arq+"("+asc+")\n" + StatisticTest.estatisticas(data, asc, outFile));
				//System.out.println( "Estatísticas -- "+arq+"("+asc+")\n" + StatisticTest.estatisticas(data, asc) ); ///

				outFile.write("Win/Tie/Loss -- "+arq+"\n" + StatisticTest.tabelaDesempenho(data, asc));
	 ...
	 * @throws IOException 
	 */
	public static String estatisticas(Instances dataResults, boolean asc, BufferedWriter outFile) throws IOException{
		...
		try{
			...
			outFile.write("erro calculando pvalue Friedman: nc="+nc+"--nl="+nl+"--FF="+F_Friedman+"\n"+e.getMessage());
	...
	public static String estatisticas(double [][]matriz, boolean asc, BufferedWriter outFile) throws IOException{
        StringBuffer statsResults = new StringBuffer(); 
		...
		outFile.write("ChiFriedman: "+ chiFriedman+" F_Friedman: "+F_Friedman+" df1: "+(nc-1)+" df2:"+ (nc-1)*(nl-1));
